...
In this thesis, simulations of \acrfull{tbl} over curved walls under \acrfull{zpg} conditions were performed to enable an isolated investigation of curvature-induced effects in the \acrshort{tbl}.
...
Using this methodology,  \acrlong{dns} of \acrlong{tbl} were carried out for three convex curved geometries with different curvature characteristics.
The results were compared with simulations of curved boundary layers under reference conditions as well as with reference data from flat-plate \acrlong{tbl} simulations.
