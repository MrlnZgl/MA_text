...
The following chapter introduces the foundational theory and simulations techniques that will be used throughout this work.
Since we study \benennung{\acrfull{tbl}} we give a short overview about the theoretical background of these flows.
Following, the necessity of this work is discussed within the context of relevant literature focussing on curved boundary layers.
The last section outlines the applied optimization method and gives an overview about the used tools.
...
In addition, we take the viscous property of fluids into account which for a Newtonian fluid relates shear stresses to the rate of strain \citep{tennekes_first_1972}
...
With increasing Reynolds number the fluid arrives first the transitional region between laminar and turbulent until it reaches a fully turbulent state.
