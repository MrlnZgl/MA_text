...
The results demonstrate that the optimisation algorithm effectively controls  the pressure field and achieves an approximately constant pressure-gradient distribution on a global scale. 
