...
In order to undertake this task, we compare the statistics of case R100deg30 in optimised and base configurations with the ones from the plane \acrfull{tbl} setup and the reference data for plane \acrshort{tbl} simulations from \citet{schlatter_assessment_2010}, which has previously been introduced.
