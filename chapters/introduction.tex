...
This phenomenon has been observed in all technical applications where a fluid is confined by a wall, such as the fluid within a pipe or around an airfoil \citep{marusic_wall-bounded_2010}.
...
Nevertheless, only a limited number of studies have focused on \acrshort{tbl} along curved surfaces, despite the fact that curved geometries are common in real-world applications \citep{spalart_direct_2024}.
...
Additionally, \citet{chiwanga_effect_1993} yielded noteworthy insights regarding the differences between turbulent structures along a flat wall and a convex curved wall.
...
It is possible to adjust the shape of the upper wall by manipulating the position of the movable control points,
