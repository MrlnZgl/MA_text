...
Due to the curved shape, a pressure gradient in streamwise direction builds up naturally which makes it hard to separate the source of observed physical effects \citep{so_experiment_1973}. 
...
First, a boundary layer along a convex wall with \acrshort{zpg} shows a smaller growth rate compared to a straight developing \acrfull{tbl} \citep{so_experiment_1973}, \citep{meroney_turbulent_1975}. 
