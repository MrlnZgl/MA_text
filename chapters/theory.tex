...
For simplicity,  free-stream velocity $U_0$  is often set to be 1. 
...
The merits of these non-dimensional scales are twofold.  Firstly, they are universal for all wall-bounded flows enabling the comparison between flows of different physical dimensions \citep{von_karman_mechanische_1930}.
...
%
In order to resolve this issue, a number of different approaches can be adopted  to derive additional equations such ensuring that all terms can be computed. These approaches are described in detail in fundamental books like \citet{wilcox_turbulence_2006,pope_turbulent_2015,moin_fundamentals_2024}.
