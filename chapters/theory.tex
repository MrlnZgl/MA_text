...
\begin{figure}[H]
    \centering
    \input{images/theory/Uplus_referenceOnly_txt.pgf}
    
    \caption{Comparison of velocity profiles in viscous scales for different $Re_\theta$, data taken from \acrshort{tbl} simulations from \citet{balasubramanian_direct_2023}; \lswatch[dashed]{uplusrefcol}~denotes the \benennung{linear law} and the \benennung{log law}.}
