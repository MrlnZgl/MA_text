...
In this thesis, \acrlong{tbl}s (TBL) along curved walls were investigated.
...
However, in flows along a curvature, a pressure gradient naturally arises, induced by the geometry.
...
This is a benificial pressure distribution, since \acrlong{tbl} along flat plate walls under \acrlong{zpg} conditions are well-studied and provide an established reference setup.
...
The position of these \benennung{control points} is optimised such that the Clauser parameter $\beta$ at the lower wall fits a prescribed target value.
The Clauser parameter corresponds to the non-dimensionalisation of the pressure gradient.
Once the optimisation has converged, the result was applied on a domain for a \acrshort{dns}.
In order to accomplish this objective, the velocities along a designated wall-normal height were extracted.
...
Nonetheless, fluctuations in the pressure distribution manifest locally, and are also present in the distribution of the Clauser parameter.
XX optimisation R100deg90 
The effects of different curvatures are studied through a comparison of case R100deg90 and R500deg18.
XX curvature effects
...
The positioning of the fluctuations suggests a correlation with the location  of the \benennung{control points} used during the optimisation.
...
In order to obtain a more profound of the pressure fluctuations, further tests are required in future research.
