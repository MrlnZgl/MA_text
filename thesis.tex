...
\documentclass[
% a4paper,             					% Benutzt DIN-A4-Papier-Format (=default)								% Zeigt todonotes-Kommentare an (vor finalem Compile wieder entfernen)
...
% PDF-Erstellung
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hypersetup{pdftitle = {Direct numerical simulation of turbulent boundary layers with curvature},
pdfauthor = {Marlene Ziegler}}
...
\end{figure}
		...
		\LARGE {\textbf{Direct numerical simulation \\ of turbulent boundary layers with curvature}}\\ [25mm]
		\huge {\textbf{Master's Thesis}} \\ [14mm]
		 by \\ [2mm]
		\LARGE \textbf{Marlene Ziegler}\\[5mm]
		\LARGE Stud.reg.no. 22522807\\[5mm]
...
\end{titlepage}
	...
	\begin{tabular}[H]{ll}
	  Author:& Marlene Ziegler \\
	  Student Registration Number: & 22522807 \\
	  Institute: & Institute of Fluid Mechanics\\
	  Head of Institute: & Prof.\ Dr.\  Philipp Schlatter\\ 
	  Group and Supervisor:& Prof.\ Dr.\ Philipp Schlatter \\		
	  Assigned: & 01.02.2026 \\
	  Submitted: & 31.07.2026 \\
	  \\
	  LSTM Technical Report: & 17/2026
	\end{tabular}	
